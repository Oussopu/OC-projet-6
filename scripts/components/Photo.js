//cree une instance de la classe photo et renvoi un bloc HTML dynamique de ces donnees
export class Photo {
    constructor(data) {
      this._id = data.id
    ...
    render() {
      return `
        <div class="media" data-id="${this._id}">
          <img loading="lazy" src="assets/photographerMedia/${this._image}" 
          alt="${this._title}">
          <div class="media-info">
            <p class="media-name">${this._title}</p>
            <div class="media-likes">
              <p class="likes-count" data-id="${this._id}">${this._likes}</p>
              <button class="like-button" aria-pressed="${this._liked}" 
              aria-label="${this._liked ? "Retirer un like" : "Ajouter un like"}">
